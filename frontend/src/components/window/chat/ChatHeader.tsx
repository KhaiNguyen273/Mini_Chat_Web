...
function ChatHeader({ displayName, displayAvatar, onToggleInfo, onBack, conversationType, otherUserId, groupAvatarUrl, members }: ChatHeaderProps) {
  ...
  return (
    <div className="flex items-center justify-between px-4 py-3 bg-white border-b border-[#e6ebef]">
      <div className="flex items-center gap-1 min-w-0">
        ...
        <button className="flex items-center gap-3 rounded-xl px-2 py-1 transition-colors cursor-default min-w-0">
